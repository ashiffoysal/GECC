                ...
                <div class="d-flex align-items-center">
                    <div class="me-auto">
                        ...
                        <div class="d-inline-block align-items-center">
                            <nav>
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item active" aria-current="page">Create Partner Settings
                                    </li>
                                </ol>
                            </nav>
                        </div>
                    ...
                    <div class="col-lg-8 col-12" data-select2-id="select2-data-10-a2dv">
                        <div class="box" data-select2-id="select2-data-9-1wo6">
                            <div class="box-header with-border">
                                <h4 class="box-title">Create Partner Item</h4>
                                        ...
                                        <div class="row" data-select2-id="select2-data-5-na3v">
                                            ...
                                            <div class="col-lg-12 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="site_link" id="site_link" value=""
