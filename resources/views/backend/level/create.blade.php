            ...
            <div class="d-flex align-items-center">
                <div class="me-auto">
                    ...
                    <div class="d-inline-block align-items-center">
                        <nav>
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item active" aria-current="page">Create Level Settings
                                </li>
                            </ol>
                        </nav>
                    </div>
            ...
            <div class="col-lg-8 col-12" data-select2-id="select2-data-10-a2dv">
                <div class="box" data-select2-id="select2-data-9-1wo6">
                    <div class="box-header with-border">
                        <h4 class="box-title">Create Level Item</h4>
           
                    </div>
                    <form action="{{ route('admin.level.store') }}" method="post" enctype="multipart/form-data" data-select2-id="select2-data-8-mhk5">
                                ...
                                <div class="row" data-select2-id="select2-data-5-na3v">
                                    <div class="col-lg-12 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="title" id="level_title" value="{{ old('title') }}"
                                      ...
                                      <div class="col-lg-12 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="total_students" id="total_students" value="{{ old('total_students') }}"
                                    ...
                                    <div class="col-lg-12 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="course_duration" id="course_duration" value="{{ old('course_duration') }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="course_credits" id="course_credits" value="{{ old('course_credits') }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="total_semester" id="total_semester" value="{{ old('total_semester') }}"
                                    ...
                                    <div class="col-lg-12 col-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="file" name="image" id="blog_image" value="{{ old('blog_image') }}"
                                                class="form-control">
                                                @error('blog_image')
                                                <div class="alert-danger">{{ $message }}</div>
                                                @enderror
