                                ...
                                <div data-select2-id="select2-data-7-06ld">
                                    <div class="box-body" data-select2-id="select2-data-6-nwe3">
                                        <div class="row" data-select2-id="select2-data-5-na3v">
                                            ...
                                            <div class="col-lg-12 col-12">
                                                <div class="box-body">
                                                    <div class="demo-radio-button">
                                                        <input name="is_video" type="radio" id="radio_1" value="0" checked>
                                                        <label for="radio_1">Is Text Review</label>

                                                        <input name="is_video" type="radio" id="radio_2" value="1">
                                            ...
                                            <!-- Video URL Section -->
                                            <div class="col-lg-12 col-12" id="video_section" style="display: none;">
                                                <div class="form-group">
