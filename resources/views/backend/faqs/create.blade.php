            ...
            <div class="d-flex align-items-center">
                <div class="me-auto">
                    ...
                    <div class="d-inline-block align-items-center">
                        <nav>
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item active" aria-current="page">Create FAQ Settings
                                </li>
                            </ol>
                        </nav>
                    </div>
            ...
            <div class="col-lg-8 col-12" data-select2-id="select2-data-10-a2dv">
                <div class="box" data-select2-id="select2-data-9-1wo6">
                    <div class="box-header with-border">
                        <h4 class="box-title">Create FAQ Item</h4>
           
                    </div>
                    <form action="{{ route('admin.faqs.store') }}" method="post" enctype="multipart/form-data" data-select2-id="select2-data-8-mhk5">
                                ...
                                <div class="row" data-select2-id="select2-data-5-na3v">
                                    <div class="col-lg-12 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="faq_question" id="faq_question" value="{{ old('faq_question') }}"
                                      ...
                                      <div class="col-lg-12 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="faq_answer" id="faq_answer" value="{{ old('faq_answer') }}"
