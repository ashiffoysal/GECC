            ...
            <div class="d-flex align-items-center">
                <div class="me-auto">
                    ...
                    <div class="d-inline-block align-items-center">
                        <nav>
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item active" aria-current="page">Create Event Settings
                                </li>
                            </ol>
                        </nav>
                    </div>
            ...
            <div class="col-lg-8 col-12" data-select2-id="select2-data-10-a2dv">
                <div class="box" data-select2-id="select2-data-9-1wo6">
                    <div class="box-header with-border">
                        <h4 class="box-title">Create Event Item</h4>
           
                    </div>
                    <form action="{{ route('admin.event.store') }}" method="post" enctype="multipart/form-data" data-select2-id="select2-data-8-mhk5">
                                ...
                                <div class="row" data-select2-id="select2-data-5-na3v">
                                    <div class="col-lg-12 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="title" id="event_title" value="{{ old('event_title') }}"
                                      ...
                                      <div class="col-lg-12 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="tags" id="event_tags" value="{{ old('tags') }}"
                                    ...
                                    <div class="col-lg-12 col-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="file" name="image" id="event_image" value="{{ old('image') }}"
                                                class="form-control">
                                                @error('image')
                                                <div class="alert-danger">{{ $message }}</div>
                                                @enderror
