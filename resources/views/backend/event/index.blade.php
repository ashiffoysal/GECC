          ...
          <div class="container-full">
              ...
              <div class="content-header">
                  <div class="d-flex align-items-center">
                      <div class="me-auto">
                          <h3 class="page-title">All Event Items</h3>
                                          ...
                                          <tbody>
                                              @foreach ($allData as $key => $data)
                                                  <tr>
                                                      ...
                                                      <td><img src="{{ asset('' . $data->image) }}" alt="Event Image"
                                                              width="100"></td>
                                                      <td>
                                                          @if ($data->is_active == 1)
                                                      ...
                                                      <td>
                                                          @if ($data->is_active == 1)
                                                              <a href="{{ route('admin.event.inactive', $data->id) }}"
                                                                  class="btn btn-danger">Inactive</a>
                                                          @else
                                                              <a href="{{ route('admin.event.active', $data->id) }}"
                                                          ...
                                                          <a id="delete"
                                                              href="{{ route('admin.event.delete', $data->id) }}"
