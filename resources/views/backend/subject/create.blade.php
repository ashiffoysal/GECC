            ...
            <div class="d-flex align-items-center">
                <div class="me-auto">
                    ...
                    <div class="d-inline-block align-items-center">
                        <nav>
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item active" aria-current="page">Create Subject Settings
                                </li>
                            </ol>
                        </nav>
                    </div>
        ...
        <div class="row">
            <div class="col-lg-8 col-12" data-select2-id="select2-data-10-a2dv">
                <div class="box" data-select2-id="select2-data-9-1wo6">
                    ...
                    <form action="{{ route('admin.subject.store') }}" method="post" enctype="multipart/form-data" data-select2-id="select2-data-8-mhk5">
                                ...
                                <div class="row" data-select2-id="select2-data-5-na3v">
                                    ...
                                    <div class="col-lg-12 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="waiver" id="waiver" value=""
                                    ...
                                    <div class="col-lg-12 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="scholarship" id="scholarship" value=""
                                    ...
                                    <div class="col-lg-12 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="course_duration" id="course_duration" value=""
                                       ...
                                       <div class="col-lg-12 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="course_credits" id="course_credits" value=""
                                    ...
                                    <div class="col-lg-12 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="total_semester" id="total_semester" value=""
                                    ...
                                    <div class="col-lg-12 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="total_students" id="total_students" value=""
